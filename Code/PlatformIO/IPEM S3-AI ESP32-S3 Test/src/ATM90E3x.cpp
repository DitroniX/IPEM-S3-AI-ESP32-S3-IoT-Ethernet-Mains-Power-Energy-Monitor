...
int ATM90E3x::Read16Register(signed short regh_addr)
{
  int val, val_h, val_l;
...
#if ATM90DEVICE == ATM90E32_DEVICE || ATM_SPLIT_PHASE == true
...
#if ATM90DEVICE == ATM90E36_DEVICE && ATM_SPLIT_PHASE == false
...
// **************** MEASUREMENT CALIBRATION REGISTERS ****************
  ...
  // N
  CommEnergyIC(WRITE, IgainN, _iGainN); // D line current gain
...
int ATM90E3x::ReadRegister(signed short regh_addr, String reg_desc)
{
  ...
  Serial.print("0x");
  Serial.print(Read16Register(regh_addr), HEX);
...
unsigned short ATM90E3x::GetRegisters()
{
  ...
  // Serial.println("All ATM Registers");
...
unsigned short ATM90E3x::GetCalibrationRegisters()
{
  float LineVoltage, LineCurrentCT, CalculatedPowerCT;
  int16_t Address;
...
// #if ATM_SINGLE_PHASE == true || ATM_SPLIT_PHASE == true

#if ATM_SINGLE_PHASE == true // Single Mains Voltage for all Current Measurements
  Serial.println("Single Phase Mains Voltage Selected.  Only V1 is used, for CT1, CT2, CT3\n");
  Serial.println("Remember to use PCB Jumpers to link V1, V2 and V3");
  Serial.println("or use external wire jumpers in V1, V2, and V3.\n");
#endif

#if (ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == true) // Split Phase Mains Voltage for all Current Measurements
  Serial.println("Split Phase Mains Voltage Selected.  Only V1/CT1 and V3/CT3 are used.\n");
#endif

#if (ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == false) // Three Phase Mains Voltage for all Current Measurements
  Serial.println("Three Phase Mains Voltage Selected.  V1/CT1, V2/CT2 and V3/CT3 are used.\n");
#endif

// #endif

// Single, Split or Three Phase  
LineVoltage = GetLineVoltage1();
  Address = 0x61;
  Serial.println("AC Mains Extrapolated Voltage: " + String(LineVoltage) + " V\n");
  Serial.print("UGain V1\t0x");
  Serial.print(Address, HEX);
  Serial.print("\t0x");
  Serial.print(Read16Register(Address), HEX);
  Serial.print(" (");
  Serial.print(Read16Register(Address), DEC);
  Serial.print(")\t");
  Serial.print(LineVoltage);
  Serial.println(" V\n");

// Three Phase
  #if ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == false
  LineVoltage = GetLineVoltage2();
  Address = 0x65;
  Serial.print("UGain V1\t0x");
  Serial.print(Address, HEX);
  Serial.print("\t0x");
...
// Split or Three Phase  
#if (ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == true) || (ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == false)
  LineVoltage = GetLineVoltage3();
  Address = 0x69;
  Serial.print("UGain V1\t0x");
  Serial.print(Address, HEX);
  Serial.print("\t0x");
  ...
  LineCurrentCT = GetLineCurrentCT1();
  Address = 0x62;
  CalculatedPowerCT = LineVoltage * LineCurrentCT;
  Serial.print("IGain CT1\t0x");
  Serial.print(Address, HEX);
  Serial.print("\t0x");
  Serial.print(Read16Register(Address), HEX);
  Serial.print(" (");
  Serial.print(Read16Register(Address), DEC);
  Serial.print(")\t");
  Serial.print(LineCurrentCT);
  Serial.print(" A\t");
  Serial.print(CalculatedPowerCT);
  Serial.println(" W");

#if ATM_SINGLE_PHASE == true || (ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == false)
  LineCurrentCT = GetLineCurrentCT2();
  Address = 0x66;
  CalculatedPowerCT = LineVoltage * LineCurrentCT;
  Serial.print("IGain CT2\t0x");
  Serial.print(Address, HEX);
  Serial.print("\t0x");
  Serial.print(Read16Register(Address), HEX);
  Serial.print(" (");
...
// Single, Split or Three Phase
// #if ATM_SINGLE_PHASE == true || (ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == true) || (ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == false)
  LineCurrentCT = GetLineCurrentCT3();
  Address = 0x6A;
  CalculatedPowerCT = LineVoltage * LineCurrentCT;
  Serial.print("IGain CT3\t0x");
  Serial.print(Address, HEX);
  Serial.print("\t0x");
  Serial.print(Read16Register(Address), HEX);
  Serial.print(" (");
...
// Three Phase
#if ATM_SINGLE_PHASE == false && ATM_SPLIT_PHASE == false
  LineCurrentCT = GetLineCurrentCTN();
  Address = 0x6D;
  CalculatedPowerCT = LineVoltage * LineCurrentCT;
  Serial.print("IGain CTN\t0x");
  Serial.print(Address, HEX);
  Serial.print("\t0x");
  Serial.print(Read16Register(Address), HEX);
  Serial.print(" (");
