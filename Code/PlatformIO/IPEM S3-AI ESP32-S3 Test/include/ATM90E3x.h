...
// On IPEM Plus, Set required ATM90E3x device, ATM90E32_DEVICE or ATM90E36_DEVICE
#define ATM90DEVICE ATM90E36_DEVICE

// **************************************************************************************************************************************************


// ******************************************************* BOARD CONFIGURATION MODE *****************************************************************

// **************** DEFINE VOLTAGE REFERENCE ****************
// Read this page https://github.com/DitroniX/IPEM-Plus-ESP32-C5-LoRa-LoRaWAN-IoT-Mains-Power-Energy-Monitor/wiki/AC-Mains-Voltage-Sense-Input 

#define ATM_SINGLE_PHASE true // Set to true to use V1/ATM_V1P for VoltageGain1, VoltageGain2, VoltageGain3 and Calculations for CT1, CT2, CT3, CT4, CTN.  (Default true)

// **************** DEFINE PHASE TYPE ****************
#define ATM_SPLIT_PHASE false // If Split Phase (i.e. USA 120+120), set to true else leave false (NB. Not fully tested). ATM_SINGLE_PHASE = false
...
private:
	...
	int Read16Register(signed short regh_addr);

	int Read32Register(signed short regh_addr, signed short regl_addr);

	int ReadRegister(signed short regh_addr, String reg_desc);
...
/* Initialization Functions */
	...
	unsigned short GetCalibrationRegisters();
