...
// RGB
#define PIN_WS2812B 48  // The ESP32-C6 pin GPIO8 connected to WS2812B
...
void loop() {
  ...
  if (digitalRead(User_GP2) == LOW) {

    Serial.println("User User_GP2");

    pinMode(User_GP2, OUTPUT);

    // Red Panel LED
    digitalWrite(User_GP2, LOW);
    delay(500);
    digitalWrite(User_GP2, HIGH);
    delay(500);
    digitalWrite(User_GP2, LOW);
    delay(500);
    digitalWrite(User_GP2, HIGH);
